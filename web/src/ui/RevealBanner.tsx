...
export function RevealBanner({ group }: { group: Group }) {
  return (
    <div data-testid="reveal-banner" style={{ position: 'sticky', top: 0, zIndex: 10, background: 'var(--teal)', color: 'var(--cream)', padding: '.6rem .8rem', textAlign: 'center', fontWeight: 600, fontSize: '.85rem' }}>
